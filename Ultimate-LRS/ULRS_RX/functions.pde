...
void Gyro_Stabilized_Servo_Drive(void) {
    Servo_Position[AILERON] = Servo_Buffer[AILERON]
            + (Gyro_ROLL / Gyro_Roll_Gain);  //Aileron
    Servo_Position[ELEVATOR] = Servo_Buffer[ELEVATOR]
            + (Gyro_PITCH / Gyro_Pitch_Gain);  //Elevator
    Servo_Position[THROTTLE] = Servo_Buffer[THROTTLE];
...
void Basic_Quadro_Copter_Servo_Drive(void) {
    Servo_Position[0] = Servo_Buffer[2] + (Gyro_PITCH / Gyro_Pitch_Gain)
            - (Gyro_YAW / Gyro_Yaw_Gain);  //front motor
    Servo_Position[1] = Servo_Buffer[2] - (Gyro_ROLL / Gyro_Roll_Gain)
            + (Gyro_YAW / Gyro_Yaw_Gain);  //right motor
    Servo_Position[2] = Servo_Buffer[2] - (Gyro_PITCH / Gyro_Pitch_Gain)
            - (Gyro_YAW / Gyro_Yaw_Gain);  //back motor
    Servo_Position[3] = Servo_Buffer[2] + (Gyro_ROLL / Gyro_Roll_Gain)
            + (Gyro_YAW / Gyro_Yaw_Gain);  //left motor
